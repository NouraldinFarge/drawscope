...
The banner and social image communicate verified repository facts—version, archive size, signal count, evaluation bound, and implementation stack. They do not depict or advertise a predicted lottery outcome.
